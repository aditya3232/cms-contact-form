...
<form action="{{ route('contacts.store') }}" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded shadow-md" onsubmit="return confirm('Are you sure to create this contact?');">
    @csrf
    <div class="mb-4">
